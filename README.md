...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Then I had a thought: 'What if the use case suggests using a NoSQL database instead of SQL and we need to convert the existing SQL data?' So, I created a Python script to convert SQL data to JSON, moved it to MongoDB, and tweaked the app to talk to MongoDB instead of MySQL. Finally, I deployed it on two EC2 instances.
